...
COST_ROADWAY = 6  # Cost per meter on roadway
COST_TRAFFIC_SIGNALS = 0  # Additional cost at traffic-signal crossings
COST_ZEBRA_CROSSING = 250  # Additional cost at zebra/marked crossings
COST_UNCONTROLLED_CROSSING = 375  # Additional cost at uncontrolled crossings
COST_ROADWAY_CROSSING = 3750  # Penalty for exiting a crossing onto a roadway
COST_CENTRALITY_FACTOR = 31.25  # Multiplier for edge centrality penalty (0 = disabled)
